                    ...
                    <div className="flex flex-col lg:flex-row items-start justify-between gap-6">
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600 mb-6">
                                Analysis for <span className="font-semibold text-gray-800">{analysis.user.firstName} {analysis.user.lastName}</span> (Age: {analysis.age})
                            </p>
                        ...
                        <div className={`flex flex-col items-center justify-center p-6 rounded-3xl border-2 min-w-[220px] shadow-sm transform transition-all hover:scale-105 ${analysis.riskCalculation.riskLevel === 'Very High' ? 'bg-rose-50 border-rose-200 text-rose-700 shadow-rose-100' :
                            ...
                            <div className="flex items-baseline gap-1 mb-2">
                                <span className="text-5xl font-black tracking-tighter">
                                    {Number(analysis.riskCalculation.riskScore)}
                                </span>
                                <span className="text-2xl font-bold opacity-80">%</span>
                            </div>
                            <div className="text-sm font-black uppercase tracking-widest px-4 py-1.5 rounded-full bg-white/60 backdrop-blur-md shadow-sm border border-white/40">
