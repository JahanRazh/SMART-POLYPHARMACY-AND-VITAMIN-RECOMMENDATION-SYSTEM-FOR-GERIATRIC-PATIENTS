              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <div className="flex flex-col space-y-1">
                    <Link href="/polypharmacy-risk" className="text-gray-400 hover:text-white transition text-base">
                      Risk Assessment
                    </Link>
                    <Link href="/vitamin-deficiency" className="text-gray-400 hover:text-white transition text-base">
                      Vitamin Analysis
                    </Link>
                    <Link href="/drug-interactions" className="text-gray-400 hover:text-white transition text-base">
                      Drug Interactions
                    </Link>
                    <Link href="/nutrition-planning" className="text-gray-400 hover:text-white transition text-base">
                      Nutrition Planning
                    </Link>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col space-y-1">
                    <Link href="/research-papers" className="text-gray-400 hover:text-white transition text-base">
                      Research
                    </Link>
                    <Link href="/clinical-trials" className="text-gray-400 hover:text-white transition text-base">
                      Clinical Trials
                    </Link>
                    <Link href="/provider-network" className="text-gray-400 hover:text-white transition text-base">
                      Provider Network
                    </Link>
                    <Link href="/support" className="text-gray-400 hover:text-white transition text-base">
                      Support
                    </Link>
                  </div>
                </div>
